...
def trajGenIter(r0, v0, k, beta, f0, wf0, rs, Tmax, dt, total_trajectories):
    ...
    for i in range(total_trajectories):
        ...
        plt.scatter(rs[0], rs[1], s=25, c='r', lw=0)
...
if __name__ == '__main__':
    pos, velos, accels, source_finds, Tfind_avg = main(r0=[1., 0], v0=[0, 0.4], k=1e-6, beta=2e-7, f0=3e-6, wf0=5e-7, rs = [0.13, 0.01], Tmax=30.0, dt=0.01, total_trajectories=15)
