...
def main(agent_pos="cage", v0_stdev=0.01, k=0., beta=4e-6, rf=4e-6, wtf=7e-7, target_pos="left", Tmax=15.0, dt=0.01, total_trajectories=200, detect_thresh=0.023175, wallF=(80, 1e-4), bounded=True, bounce="crash", plotting = True):
